function [virtualEyeWorldPoint, nodalPointIntersectError] = virtualImageFuncPreMex( eyeWorldPoint, extrinsicTranslationVector, eyeAzimuth, eyeElevation, eyeTorsion, rotationCenters)
% Calculate coord of virtual image of eyeWorldPoint
%
% Syntax:
%  virtualEyeWorldPoint = virtualImageFuncPreMex( eyeWorldPoint, extrinsicTranslationVector, eyeAzimuth, eyeElevation, eyeTorsion, rotationCenters)
%
% Description:
