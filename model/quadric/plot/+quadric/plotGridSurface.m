function p = plotGridSurface(S,boundingBox,surfColor,surfAlpha,betaLineColor,omegaLineColor,lineAlpha,bbTol,meshGridSamples)
% Add a 3D plot of the quadric surface to the active figure
%
% Syntax:
%  p = quadric.plotGridSurface(S,boundingBox,surfColor,surfAlpha,betaLineColor,omegaLineColor,lineAlpha,bbTol,meshGridSamples)
%
% Description:
%   Creates a meshgrid on the quadric surface and plots this as a mesh
%   surface, using the supplied face color and alpha transparency. A bit
%   faster and light weight compared to plotImplicitSurface
%
% Inputs:
...
%{
    ...
    figure
    quadric.plotGridSurface(S, boundingBox, 'k', 0.25, 'red');
    camlight
%}
