...
% determined under cycloplegia. The data relates kappa to spherical
% refractive error.
%
...
% value for an emmetropic eye, and v is a fit parameter. The value of v was
% found to be 17.8 diopters.
%{
