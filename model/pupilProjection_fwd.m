...
%{
    ...
    sceneGeometry=createSceneGeometry('skipEyeLandmarks',true','skipNodalPoint',true);
    ...
    pupilEllipseOnImagePlaneCached = [0.027812709087498   0.022384557314321   1.558259276811619   0.000022611126408   0.000192106525886].*1e4;
