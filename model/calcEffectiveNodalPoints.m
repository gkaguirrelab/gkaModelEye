function [ nodeAnterior, nodePosterior ] = calcEffectiveNodalPoints(eye,cameraMedium)
% Returns the effective nodal points for an eye in a given medium
%
% Syntax:
%  [ nodeAnterior, nodePosterior ] = calcEffectiveNodalPoints(eye,cameraMedium)
%
% Description
