...
% There is also some business here to deal with the cylinder and axis
% returned by calcOpticalPower.
myObj = @(p) norm(diopters-sum(calcOpticalPower(mySystem(p),1000,radius*0.65).*[1 0 0]));
